        ...
        actions: [
          TextButton(
            onPressed: () async {
              ...
              await Alarm.stop(id);
              Alarm.set(alarmSettings:
              AlarmSettings(
                id: id,
                dateTime: DateTime.now().add(Duration(minutes: 5)), assetAudioPath: 'assets/alarm.mp3', 
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text("Your alarm will ring again after 5 minutes!",
                  style: TextStyle(
                    color: Colors.black),
                  ),
                  duration: Duration(seconds: 4),
                  backgroundColor: const Color.fromARGB(255, 0, 255, 240),
                ),
                );

              Navigator.of(context).pop();
            },
            child: Text('Snooze', style: TextStyle(fontSize: 24, color: Colors.cyan),),
          ),
                        ...
                        child: Row(
                          children: [
                            ...
                            IconButton(onPressed: () => {
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text("Alarm for $alarmText deleted succesfully!", style: TextStyle(color: Colors.black),),
                                  duration: Duration(seconds: 3),
                                  backgroundColor: const Color.fromARGB(255, 0, 255, 240),
                                ),
                                ),
                              delIndex(index)},
                            icon: Icon(Icons.delete), color: Color.fromARGB(255, 0, 255, 240),)
                          ],
                        )
                      );
                    })
